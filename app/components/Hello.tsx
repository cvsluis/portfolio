...
export default function Hello() {
  return (
    <div className="p-8 md:px-28 flex min-h-screen md:min-h-[80vh] flex-col justify-center items-center gap-12">
      <div className="flex flex-col gap-8">
        <h1 className="font-dm md:pt-36 text-center text-6xl md:text-8xl">
          Caitlin Vandersluis
        </h1>
